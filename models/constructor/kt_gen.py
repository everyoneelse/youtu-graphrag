...
DEFAULT_SEMANTIC_DEDUP_VALIDATION_PROMPT = (
    ...
    "    }}\n"
    "  ],\n"
    "  \"corrected_groups\": [{{ \"members\": [...], \"representative\": N, \"rationale\": \"...\" }}]\n"
    "}}\n\n"
    "If consistent:\n"
    "{{\n"
    ...
    "    \"group_ids\": [1, 0],\n"
    "    \"issue_type\": \"conclusion_structure_mismatch\",\n"
    "    \"description\": \"Group 1 says '故归入一组' (merge) but members are separate\",\n"
    "    \"suggested_fix\": \"merge group 1 into group 0\"\n"
    "  }}],\n"
    "  \"corrected_groups\": [\n"
    "    {{\"members\": [1, 4], \"representative\": 1, \"rationale\": \"振铃伪影与边缘振荡伪影视角相同，归为一组\"}}\n"
    "  ]\n"
    "}}\n\n"
    "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
    "ANTI-PATTERN - What NOT to report:\n"
    "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
    "If rationale's CONTENT has errors but STRUCTURE is correct:\n"
    "  → ✅ CONSISTENT (do not report)\n\n"
    "Examples:\n"
    "- Rationale mentions details not in original text\n"
    "- Rationale uses wrong terminology\n"
    "- Rationale's reasoning is flawed\n\n"
    "As long as: rationale conclusion = actual structure → CONSISTENT\n\n"
    "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
)
