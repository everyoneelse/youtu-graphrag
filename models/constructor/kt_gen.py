...
DEFAULT_SEMANTIC_DEDUP_PROMPT = (
    ...
    "{{\n"
    "  \"groups\": [\n"
    "    {{\"members\": [1, 3], \"representative\": 3, \"rationale\": \"Candidates [1] and [3] refer to the same entity because...\"}}\n"
    "  ]\n"
    "}}\n\n"
    "═══════════════════════════════════════════════════════════════════════════════\n"
...
DEFAULT_ATTRIBUTE_DEDUP_PROMPT = (
    ...
    "   Step 1: Read your rationale for each group\n"
    "   Step 2: Extract ALL candidate numbers mentioned in that rationale\n"
    "   Step 3: If rationale uses equivalence language ('same value as', 'merge with', 'equivalent to', etc.):\n"
    "           → ALL mentioned candidates MUST be in that group's members array\n"
    "   Step 4: If rationale says candidates are DIFFERENT values:\n"
    "           → They MUST be in DIFFERENT groups\n\n"
    "   ⚠️  FORBIDDEN PATTERNS (these will cause errors):\n"
    ...
    "{{\n"
    "  \"groups\": [\n"
    "    {{\"members\": [1, 3], \"representative\": 3, \"rationale\": \"Candidates [1] and [3] express the same value because...\"}}\n"
    "  ]\n"
    "}}\n\n"
    "═══════════════════════════════════════════════════════════════════════════════\n"
    "⚠️  FINAL CHECKLIST - Review each group before submitting:\n"
