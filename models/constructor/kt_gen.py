...
DEFAULT_SEMANTIC_DEDUP_PROMPT = (
    ...
    "PROHIBITED REPRESENTATIVE SELECTION CRITERIA (DO NOT use these as reasons to select representative):\n"
    "✗ Brevity/Conciseness: 'X is shorter' → Information completeness trumps brevity\n"
    "✗ Frequency in context: 'X appears more often' → Descriptiveness matters more than frequency\n"
    "✗ Alphabetical order: 'X comes first alphabetically' → Arbitrary ordering is irrelevant\n"
    "✗ Index order: 'X has lower index' → Index position is arbitrary\n"
    "✗ Familiarity bias: 'X is more familiar to me' → Use objective principles instead\n\n"
    "CRITICAL: Information completeness and self-explanatory nature take precedence over brevity.\n"
    "The representative should be the MOST INFORMATIVE expression, not the shortest one.\n\n"
