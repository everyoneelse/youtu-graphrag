...
DEFAULT_SEMANTIC_DEDUP_PROMPT = (
    ...
    "Your task is to identify and group ONLY those candidate tail descriptions that express EXACTLY the same information.\n\n"
    "Head entity: {head}\n"
    "Relation: {relation}\n\n"
    "Head contexts:\n{head_context}\n\n"
    "Candidate tails:\n"
    "{candidates}\n\n"
    "Instructions:\n"
    "1. Group tails ONLY when they express the EXACT SAME information or refer to the EXACT SAME entity/fact.\n"
    "   - Example of equivalent: \"延长T2时间两倍以上\" and \"T2值可延长超过2倍\" (same fact, different wording)\n"
    "   - Example of NOT equivalent: \"具有角度依赖性\" and \"延长T2时间两倍以上\" (different properties of the same topic)\n\n"
    "2. Keep tails SEPARATE when they describe different aspects, properties, or facts, even if:\n"
    "   - They are about the same topic or entity\n"
    "   - They come from the same source context\n"
    "   - They are related to each other\n\n"
    "3. Do NOT merge tails just because they are semantically related or belong to the same category.\n"
    "   - If tail A describes one characteristic and tail B describes a different characteristic, keep them separate.\n\n"
    "4. Use the provided contexts to verify whether tails express the same or different information.\n\n"
    "5. Choose the most informative and complete mention as the representative index for each group.\n\n"
    "6. Every input index must appear in exactly one group.\n\n"
    "Respond with strict JSON using this schema:\n"
    "{{\n"
    "  \"groups\": [\n"
    "    {{\"members\": [1, 3], \"representative\": 3, \"rationale\": \"Why the members express the exact same information.\"}}\n"
    "  ]\n"
    "}}\n"
)
