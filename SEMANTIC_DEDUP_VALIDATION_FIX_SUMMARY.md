...
✅ **中文关键词列表** - 包含"可合并"、"完全一致"、"故归入一组"等关键短语  
✅ **简化验证步骤** - 3步清晰流程，去除无关检查  
✅ **正反示例** - 包含"应该检测"和"不应该检测"的示例  
✅ **统一issue_type** - 使用"conclusion_structure_mismatch"

### V3.0 (2025-10-23) - 大幅简化prompt

✅ **极简设计** - 从150+行简化到~80行，去除冗余内容  
✅ **关键短语强化** - 特别强调"故归入一组"、"归入XX组"等中文表达  
✅ **步骤式示例** - 用Step 1/2/3展示推理过程，更易理解  
✅ **真实案例** - 使用用户实际遇到的"振铃伪影"案例作为示例
